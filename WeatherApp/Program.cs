...
namespace WeatherApp
{
    class Program
    {
        public static Weather FindWeatherWithLargestWindchill(Weather[] array)
        {
            ...
            {
                if (largestWindchill < array[i].CalculateWindChill())
                {
                    largestWindchill = array[i].CalculateWindChill();
                    holder = i;
                }
            }
